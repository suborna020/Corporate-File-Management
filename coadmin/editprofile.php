<h1 class="text-primary" style="color:#34495e"><i class="fa fa-pencil-square-o"></i> UPDATE ACCOUNT</h1>
        <ol class="breadcrumb">
          <li><a href="coadmin.php?page=dashboard"><i class="fa fa-dashboard"></i>Back to : <b> DASHBOARD</b></a></li>
          <li><a href="coadmin.php?page=viewprofiles"><i class="fa fa-users"></i>All Employee</a></li>
