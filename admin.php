...
<head>
    ...
    <!-- Bootstrap folder direction-->
      ...
      <script type="text/javascript" src="js/script.js"></script><!-- our style sheet-->
...
<div class="container-fluid">
    <div class="col-sm-3">
        <div class="list-group">
              <a href="admin.php?page=dashboard" style="background:#34495e" class="list-group-item active"><i class="fa fa-dashboard"></i>
                Dashboard</a>
              <a href="admin.php?page=adduser"  class="list-group-item"><i class="fa fa-user-plus"></i> Add User</a>
              <a href="admin.php?page=viewprofiles"  class="list-group-item"><i class="fa fa-users"></i> View profiles </a>
              <a href="admin.php?page=uploadedfiles"  class="list-group-item"><i class="fa fa-users"></i> Uploaded files</a>
        </div>
    </div>
  <div class="col-sm-9">
    <div class="content">
